<header class="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600">
    ...
    <div class="flex items-center">
        <?php if(Auth::user()->is_admin): ?>
            <form action="<?php echo e(route('backup.database')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
</header><?php /**PATH C:\Users\User\Desktop\Alishka Projects\paqro\resources\views/layouts/header.blade.php ENDPATH**/ ?>